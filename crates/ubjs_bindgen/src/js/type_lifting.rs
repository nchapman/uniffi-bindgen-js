...
pub(super) fn lift_return(
    ...
    // Two-pass match: first pass lifts object types, second pass coalesces Optional.
    // Both inspect `return_type` and must agree on the `needs_object_lifting` predicate.
