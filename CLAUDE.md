...
The generator produces a thin TypeScript namespace that wraps the wasm-pack JS glue:
...
- Generated function names use camelCase (e.g., `broken_greet` → `brokenGreet`)
...
| WASM fixture crate | `fixtures/simple-fns/wasm/` |
| JS smoke tests | `binding_tests/test/smoke.test.ts` |
